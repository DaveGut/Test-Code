...
0.06	a.	Added remoteControlStatus into Attributes.
		b.	Removed remainingTime from attributes
		c.	Added test attributes for alternate method to get time remaining.
===========================================================================================*/
...
//	Time Alternatives
	try {
		testLog << [compTime: mainData.dryerOperatingState.completionTime.value]
	} catch (error) {}
	try {
	...
	try {
		testLog << [dryingTime: mainData["samsungce.dryerDryingTime"].dryingTime.value]
	} catch (error) {}
